...
Note that if we look at the mean stress levels for each rating of work-life balance:
...
While the mean stress level appears to be higher for some categories of students who report missing social events, the mean difference are not signficant enough to suggest that missing social events indicates higher stress levels. 
