...
**(Anna: you need to test assumptions!)**
...
**(Anna: again, same issue... The chi square test of independence shouldn't be used here. The values have an inherent ordering and would be better off replaced by a number.)**
...
Since the calculated p-value was 0.359 and is greater than **(Anna: alpha?)** $\alpha=0.05$, we fail to reject the null hypothesis. There isn't enough statistical evidence that the living situation and the anxiety levels of a student are related.
...
**(Anna: FYI I cannot render this report; I don't have sample_data$stress.)**
...
![Residuals Plot](residuals_rq1.png){width=80%}
 ...
 1. Independence of errors: Since the plot has no noticeable pattern, the independence assumption is satisfied.
 ...
 3. Homogeneity of variances amongst errors: Since the residuals plot has a "horizontal band appearance", this suggests that the errors have mean zero and a constant variance. **(Anna: well I don't see the residual plot so I can't comment on that, but by design residuals will have mean 0. If I saw the plot I could tell you if you're wrong but I'm just going to tell you to be more careful here.)**
...
**(Anna: Although this isn't really code, it's R-output that I also discourage against. This data is fine; perhaps reformat it so it doesn't look like code (and same with the rest of the stuff that looks the same.)**
...
(https://chatgpt.com/share/674a3a7d-84cc-8013-8aa7-0d1bbfccc6db)
