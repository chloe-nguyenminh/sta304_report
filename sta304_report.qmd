...
Overall, the results of the Kruskal-Wallis tests show that the stress levels of the students sampled are primarily related to none of the anticipated factors, with  academic workload, lifestyle factors such as sleep and socializing having less of an impact on their mental health than expected. In addition, this voluntary response method was likely to result in selection bias.
