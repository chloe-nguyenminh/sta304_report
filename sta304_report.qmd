...
```{r}
# Reorder stress factor levels for the sample data
sample_data$stress <- factor(sample_data$stress, levels = c("Never", "Sometimes", "Always"))

# Create the box plot for the sample data
boxplot(academic_workload ~ stress, data = sample_data,
        main = "Box Plot of Academic Workload by Stress Levels (Sample)",
        xlab = "Stress Level",
